      ...
      ** set myflags to type TextFormatFlags::HorizontalCen
      ...
      *         set myfont to new Font("dotumche", 10, type FontStyle::Bold)
        ...
        200-DONE.
            ...
            invoke mylemonbrush::Dispose()
            invoke mybrightgreenbrush::Dispose()
            invoke mygreenbrush::Dispose()
            invoke myroyalbluebrush::Dispose()
            invoke myredbrush::Dispose()
            invoke myblackbrush::Dispose()
            invoke myyellowbrush::Dispose()
            invoke mywhitebrush::Dispose()
            invoke mycyanbrush::Dispose()
